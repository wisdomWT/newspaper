		...
		<img src ="img/header.png" width="1500PX" height="120PX" style="margin-left:-58px;magrin-right:-45px">
			...
			<c:forEach items="${listnewspaper }" var="newspaper">
			  <div class="col-md-3" style="padding-left: 7px;padding-right: 7px;">
			    <div class="thumbnail">
			      <img src="img/${newspaper.image }"  style="height: 400px;" alt="...">
			      <div class="caption"><hr>
			        <p>${newspaper.pname } &emsp;&emsp;&emsp;3r&emsp;&emsp;&emsp;&nbsp;        <button type="submit" class="btn btn-success">点我订阅</button></p>
			      </div>
			    </div>
			  </div>
			 </c:forEach>
