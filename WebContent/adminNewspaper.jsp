...
<html>
	...
	<body>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <%String uri = request.getRequestURL().toString();
		    	...
		    	%>
		        <li><a href="adminIndex.jsp">用户信息管理</a></li>
		      </ul>
		...
		<div class="col-md-2">
		<h1 style="font-size: 30px; padding-top: 10px; padding-left: 55px;">报刊管理</h1>
		</div>
		</div>	
		<!-- 报刊信息 -->
		<div class="container-fluid" style="margin-left: 50px;margin-right: 50px;margin-top:70px;">
			<table class="table table-striped table-hover table-bordered">
				...
				<c:forEach items="${listnewspaper }" var="newspaper">
					<tr>
						<td>${newspaper.pid }</td>
						<td>${newspaper.pname }</td>
						<td>${newspaper.image }</td>
						<td>
							<button type="button" style="margin-left: 5px;"  class="btn btn-info btn-xs">审核</button>
							<button type="button" style="margin-left: 5px;" class="btn btn-warning btn-xs">禁用</button>
							<span>	
							<button type="button" style="margin-left: 5px;" class="btn btn-success btn-xs ">修改</button>
							</span>
						</td>
					</tr> 
				</c:forEach>
