...
@WebServlet("/adminNewspaper")
public class AdminNewspaperServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        request.getRequestDispatcher("adminNewspaper.jsp").forward(request, response);
	}
